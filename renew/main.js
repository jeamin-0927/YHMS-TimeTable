...
var howMany = 0;
var eduCode = "C10";
var schoolName = "용호중학교";
var schoolCode = "7181097";
var schoolGrade = 2;
var grade;
var classNum;
...
function changing() {
    ...
    if (howMany != 0) {
        ...
        alert(' ' + dyy[0] + '년 ' + dyy[1] + '월 ' + dyy[2] + '일\n' + schoolName + ' ' + grade + '학년' + ' ' + classNum + '반으로 이동합니다.');
        
    }
    if (grade != "" && classNum != "") {
        var dt = document.getElementsByName('date')[0].value.split('-');
        document.getElementsByName('timeSet')[0].innerHTML = schoolName + ' ' + grade + '학년' + ' ' + classNum + '반 ';
...
var vhd = 0, vbd = 0;
function cpcpc(){
    var vh = document.getElementById("hak").value;
    var vb = document.getElementById("ban").value;
    if(vh != 0 && vb != 0 && vhd != vh && vbd != vb){
        changing();
        vhd = vh;
        vbd = vb;
    }
